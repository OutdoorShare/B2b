...
export interface HostListing {
  ...
  depositAmount: string | null;
  halfDayEnabled: boolean;
  halfDayDurationHours: number | null;
  halfDayRate: string | null;
  hourlyEnabled: boolean;
  hourlySlots: { label: string; hours: number; price: number }[] | null;
  hourlyPerHourEnabled: boolean;
  hourlyMinimumHours: number | null;
  timeSlots: { label: string; startTime: string; endTime: string; rate: string }[] | null;
  imageUrls: string[];
  location: string | null;
  quantity: number;
  condition: string | null;
