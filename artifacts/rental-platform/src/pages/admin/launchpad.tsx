  ...
  const items: LaunchItem[] = [
    {
      ...
      description: "Set your business name (anything other than the default) and a public contact email. Both are required — your storefront won't show proper info without them.",
    ...
    },
    {
      ...
      description: "Upload your logo and a cover image in Settings → Branding. They appear on your storefront, booking emails, and the rental agreement PDF.",
