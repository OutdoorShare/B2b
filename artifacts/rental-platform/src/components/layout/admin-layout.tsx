...
export function AdminLayout({ children }: { children: React.ReactNode }) {
  ...
  const sidebarContent = (
    <>
      <div className="h-[60px] flex items-center px-4 border-b border-border/60 bg-gradient-to-b from-sidebar-accent/30 to-transparent shrink-0">
        <Link href={adminBase} className="flex items-center gap-2.5 min-w-0 flex-1">
  ...
  return (
    <div className="h-[100dvh] flex flex-col md:flex-row bg-background overflow-hidden">
      {/* Desktop Sidebar */}
      <aside className="hidden md:flex w-60 h-full border-r border-border bg-sidebar flex-shrink-0 flex-col overflow-hidden">
        {sidebarContent}
      </aside>
